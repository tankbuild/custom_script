...
# identifying male specific sequences (male_SU($6) > mean_SU)
bedtools intersect -wao -f 0.5 -r -a male_del.bed -b ../female/female_del.bed | awk '$6 > 6 && $17 > 0 && $14/$6 > 1.8' > channel_Y_spe.bed
# merge SVs
