...
# sort bamfile
samtools sort -o $outdir/maleself_remapping/tomattes_L1_sorted.bam $outdir/maleself_remapping/tomattes_L1.bam
samtools sort -o $outdir/maleself_remapping/tomattes_L2_sorted.bam $outdir/maleself_remapping/tomattes_L2.bam

# merge bamfile
samtools merge $outdir/maleself_remapping/tomattes_merged.bam $outdir/maleself_remapping/tomattes_L1_sorted.bam $outdir/maleself_remapping/tomattes_L2_sorted.bam
...
java -Xmx20G -Djava.io.tmpdir=$outdir/maleself_remapping/tmp -jar /usr/local/bioinfo/src/picard-tools/picard-2.18.2/picard.jar \
     MarkDuplicates I=$outdir/maleself_remapping/tomattes_merged.bam O=$outdir/maleself_remapping/tomettes_no_duplicates.bam \
