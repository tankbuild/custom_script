...
poolsex.py=/home/mwen/work/tools/PoolSex/poolsex.py
...
then
    ln -s /home/mwen/work/genomes/goldfish/female/GCF_003368295.1_ASM336829v1_genomic.fna goldfish_genome.fasta
fi

# check reads is ready to use
if [ ! -f $rootdir/reads/*.gz ]
then
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_femelle_S2_L001_R1_001.fastq.gz female_L1_R1.fasta.gz
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_femelle_S2_L001_R2_001.fastq.gz female_L1_R2.fasta.gz
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_femelle_S2_L002_R1_001.fastq.gz female_L2_R1.fasta.gz
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_femelle_S2_L002_R2_001.fastq.gz female_L2_R2.fasta.gz
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_male_S1_L001_R1_001.fastq.gz male_L1_R1.fasta.gz
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_male_S1_L001_R2_001.fastq.gz male_L1_R2.fasta.gz
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_male_S1_L002_R1_001.fastq.gz male_L2_R1.fasta.gz
    ln -s /home/mwen/work/Project_PhyloSex.280/Run_A_melas_-_C_auratus.10511/RawData/C_auratus_male_S1_L002_R2_001.fastq.gz male_L2_R2.fasta.gz
fi
...
# run PoolSex
python $poolsex.py init -i $rootdir &&

python $poolsex.py run -i $rootdir &&
...
$poolsex_analysis --input-file $rootdir/results/mpileup2sync_female_male.sync --output-prefix $rootdir/results/goldfish_0.5_1_0.2_0.05_pool \
                  --gff-file $gff --male-pool 1 --range-het 0.2
